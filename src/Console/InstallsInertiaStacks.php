...
trait InstallsInertiaStacks
{
    ...
    protected function installInertiaVueStack()
    {
        ...
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia-vue/lang', base_path('lang'));
        ...
        if ($this->option('ts')) {
            ...
            (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia-vue-ts/resources/js/Lib', resource_path('js/Lib'));
            ...
            (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia-vue/resources/js/Lib', resource_path('js/Lib'));
        ...
        copy(__DIR__.'/../../stubs/inertia-vue/resources/sass/quasar.variables.scss', resource_path('sass/quasar.variables.scss'));
     ...
     * @return void
     */
    protected function configureReactHydrateRootForSsr($path): void
    {
        $this->replaceInFile(
            <<<'EOT'
